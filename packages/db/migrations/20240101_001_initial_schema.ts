...
export async function up(db: Kysely<unknown>): Promise<void> {
  ...
  await db.schema
    ...
    .addColumn('owner_id', 'uuid', c => c.notNull().references('users.id'))
    .addColumn('name', 'varchar(255)', c => c.notNull())
    .addColumn('value', sql`decimal(12,2)`, c => c.notNull().defaultTo(0))
  ...
  await db.schema
    ...
    .addColumn('base_fee', sql`decimal(10,2)`, c => c.notNull().defaultTo(0))
    .addColumn('overage_total', sql`decimal(10,2)`, c => c.notNull().defaultTo(0))
    .addColumn('total_bill', sql`decimal(10,2)`, c => c.notNull().defaultTo(0))
